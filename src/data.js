...
export const PROJECTS = [
  { title: "AI-FinOps", sub: "INTERNSHIP PROJECT · REACT · NODE · GEMINI", img: "/assets/aiFinops.webp",
    ...
    metric: "~30%", metricSub: "potential AWS cost savings surfaced ($226 to 298/month)",
  ...
  { title: "Sneak Peak", sub: "REACT · NODE · MONGODB", img: "/assets/snp.webp",
    ...
    metric: "500+", metricSub: "users onboarded within the first month of launch",
  ...
  { title: "Campus Circle", sub: "ANDROID · NODE · SQL", img: "/assets/im3.webp",
    ...
    metric: "1,200+", metricSub: "student sessions in the first semester on campus",
    body: "Android app for campus updates and student life - Node.js + SQL backend." },
  ...
  { title: "Typebeat", sub: "REACT · JAVASCRIPT", img: "/assets/typeBeat.webp",
    ...
    metric: "Live", metricSub: "speed and accuracy tracked keystroke by keystroke",
  ...
  { title: "This Site", sub: "REACT · TAILWIND · WEBGL", img: "/assets/portFolio.webp",
    ...
    metric: "100%", metricSub: "written, broken and rewritten by me - no templates",
    body: "This portfolio - React, Tailwind and hand-written WebGL. Not a template, a statement." },
];
