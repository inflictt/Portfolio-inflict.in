...
/* Goku - oneko-style cursor companion. Chases the pointer with easing,
   flips to face travel direction, swaps to the standing sprite when idle.
   Assumes goku.png (running) and goku-idle.png (standing) already have transparent backgrounds. */
import { useEffect, useRef } from "react";
  ...
  return (
    ...
    >
      <img
        ...
        src="/assets/goku.png"
        alt=""
        className="h-[54px] w-auto [image-rendering:pixelated]"
        onError={(e) => (e.currentTarget.style.visibility = "hidden")}
      />
      <img
        ref={idleImg}
        ...
        alt=""
        className="h-[54px] w-auto hidden [image-rendering:pixelated]"
        onError={(e) => (e.currentTarget.style.visibility = "hidden")}
      />
    </div>
  );
